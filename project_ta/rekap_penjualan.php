...
$query = "
    ...
    GROUP BY DATE_FORMAT(r.tanggal, '%H:%i')
...
// === Query jam ramai ===
$q_jam = "
    SELECT DATE_FORMAT(r.tanggal, '%H') AS jam, COUNT(*) AS jumlah_transaksi
    FROM rekap_penjualan r
    WHERE $where AND r.status = 'BELUM'
    GROUP BY DATE_FORMAT(r.tanggal, '%H')
...
<body>
    ...
    <div class="container mt-4">
        ...
        <!--script untuk menampilkan diagam-->
